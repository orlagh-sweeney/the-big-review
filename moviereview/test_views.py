...
class TestEditReviewView(TestCase):
    ...
    def test_get_add_review_page(self):
        ...
        response = self.client.get(f'/search/movie/{movie_id}/edit/{review.id}')
        self.assertEqual(response.status_code, 200)
    ...
    def test_can_edit_review(self):
        ...
        self.client.login(username='testuser', password='password')
        review = Review.objects.create(title='Test Review', author=user, movie_id='123', body='This is a review', rating='1')
        response = self.client.post(f'/search/movie/{movie_id}/edit/{review.id}', {
...
class TestDeleteReviewView(TestCase):
    ...
    def test_get_delete_review_page(self):
        ...
        self.client.login(username='testuser', password='password')
        review = Review.objects.create(title='Test Review', author=user, movie_id='123', body='This is a review', rating='1')
        response = self.client.get(f'/search/movie/{movie_id}/delete/{review.id}')
        self.assertEqual(response.status_code, 200)
    ...
    def test_can_delete_review(self):
        ...
        self.client.login(username='testuser', password='password')
        review = Review.objects.create(title='Test Review', author=user, movie_id='123', body='This is a review', rating='1')
        response = self.client.post(f'/search/movie/{movie_id}/delete/{review.id}')
        self.assertRedirects(response, (f'/search/movie/{movie_id}/'))
